 ...
 * @author hugogabriel
 */
public class ProdutosModels extends AbstractTableModel {

    private List<ProdutosPP> linhas;
    private String[] colunas = new String[]{"ID", "Produto", "Descricao", "CodigoB", "Serial", "Marca", "Preco", "Qtde", "Subtotal"};

    public ProdutosModels() {
        linhas = new ArrayList<ProdutosPP>();
    }

    public ProdutosModels(List<ProdutosPP> lista) {
        linhas = new ArrayList<ProdutosPP>(lista);
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ProdutosPP pp = linhas.get(rowIndex);
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ProdutosPP pp = linhas.get(rowIndex); // Carrega o item da linha que deve ser modificado
    ...
    public void setValueAt(ProdutosPP aValue, int rowIndex) {
        ProdutosPP pp = linhas.get(rowIndex); // Carrega o item da linha que deve ser modificado
    ...
    public ProdutosPP getProdutos(int indiceLinha) {
        return linhas.get(indiceLinha);
    }

    public void addProdutosPP(ProdutosPP f) {
        // Adiciona o registro.
        linhas.add(f);
    ...
    public void addLista(List<ProdutosPP> f) {
