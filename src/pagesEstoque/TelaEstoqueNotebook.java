 ...
 * @author hugogabriel
 */
public class TelaEstoqueNotebook extends javax.swing.JFrame {

    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;

    public TelaEstoqueNotebook() {
        initComponents();
        setIcon();
    ...
    public void colocarDadosNotebook() {
        ...
        try {
            ...
            header.repaint();
            tableNotebooks.getColumnModel().getColumn(0).setMaxWidth(50);
    ...
    private void initComponents() {
        ...
        ProdutosOff1 = new javax.swing.JRadioButton();
        btDetalhesVenda2 = new javax.swing.JButton();
        ...
        jLabel18.setText("ESTOQUE DE NOTEBOOKS");
        ...
        jButton3.setText(" Adicionar notebook a lista de impressão");
        ...
        DetalhesNotebook.setFont(new java.awt.Font("Century Gothic", 3, 12)); // NOI18N
        DetalhesNotebook.setIcon(new javax.swing.ImageIcon(getClass().getResource("/src/detalhes.png"))); // NOI18N
        DetalhesNotebook.setText("Detalhes do notebook");
        ...
        btDetalhesVenda1.setText("Cadastrar um notebook igual");

        buttonGroup1.add(ProdutosTotais);
        ProdutosTotais.setSelected(true);
        ProdutosTotais.setText("Notebooks totais");
        ...
        ProdutosDisponiveis.setText("Notebooks disponíveis");
        ...
        ProdutosOff.setText("Notebooks sem estoque");
        ...
        buttonGroup1.add(ProdutosOff1);
        ProdutosOff1.setText("Notebooks carcaça");
        ProdutosOff1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ProdutosOff1ActionPerformed(evt);
            }
        });

        btDetalhesVenda2.setFont(new java.awt.Font("Century Gothic", 3, 12)); // NOI18N
        btDetalhesVenda2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/src/mudar.png"))); // NOI18N
        btDetalhesVenda2.setText(" Troca rapida de componentes");
        btDetalhesVenda2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btDetalhesVenda2ActionPerformed(evt);
            }
        });
    ...
    private void DetalhesNotebookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DetalhesNotebookActionPerformed
        ...
        if (tableNotebooks.getSelectedRow() >= 0) {
            ...
            String getDescricao = tableNotebooks.getModel().getValueAt(setarNotes, 2).toString();
            ntb.setTitle("Notebook - " + getDescricao + "");
...
//        }
    ...
    private void ProdutosOff1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProdutosOff1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ProdutosOff1ActionPerformed

    private void btDetalhesVenda2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDetalhesVenda2ActionPerformed
        // TODO add your handling code here:
        int rowSelected = tableNotebooks.getSelectedRow();
        if (rowSelected >= 0) {
            String name = (tableNotebooks.getModel().getValueAt(rowSelected, 2).toString());
            TelaAlteracaoComp tlcomp = new TelaAlteracaoComp();
            tlcomp.setVisible(true);
            tlcomp.setTitle("Troca rapida de componente - " + name + "");
        } else {

        }

    }//GEN-LAST:event_btDetalhesVenda2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEstoqueNotebook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaEstoqueNotebook().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JRadioButton ProdutosOff1;
    ...
    private javax.swing.JButton btDetalhesVenda2;
