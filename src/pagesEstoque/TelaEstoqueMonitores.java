 ...
 * @author hugogabriel
 */
public class TelaEstoqueMonitores extends javax.swing.JFrame {

    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;

    public TelaEstoqueMonitores() {
        initComponents();
        setIcon();
    ...
    private void initComponents() {
        ...
        jLabel18.setText("ESTOQUE DE MONITORES");
        ...
        DetalhesNotebook.setText("Detalhes do Monitor");
        ...
        btDetalhesVenda1.setText("Cadastrar um monitor igual");
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEstoqueMonitores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaEstoqueMonitores().setVisible(true);
            }
        });
    }
