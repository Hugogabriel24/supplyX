...
import static pagesEstoque.TelaControleCaixa.tablePrintBox;

public final class printBox extends javax.swing.JFrame {
    ...
    public void print1x(String codabar1, String ref1) {
        ...
        if (ref1.length() >= 15) {
            ...
            try {
                ...
                ps.println("^LL0216");
                ps.println("^LS0");
                ps.println("^FO716,96^GFA,01152,01152,00012,:Z64:");
                ...
                ps.println("^BY2,2,71^FT766,38^BEI,,Y,N");
                ps.println("^FD" + codabar1 + "^FS");
                ps.println("^FT733,144^A0I,20,21^FH\\^FD" + partes[0] + "^FS");
                ps.println("^FT733,120^A0I,20,21^FH\\^FD/" + partes[1] + "^FS");
            ...
            try {
                ...
                ps.println("^BY2,2,71^FT766,38^BEI,,Y,N");
                ps.println("^FD" + codabar1 + "^FS");
                ps.println("^FT733,144^A0I,20,21^FH\\^FD" + ref1 + "^FS");
                ps.println("^PQ1,0,1,Y^XZ");
                ps.close();
                Notification noti = new Notification(this, Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Etiqueta impressa com sucesso!");
                noti.showNotification();
    ...
    public void print2x(String codabar1, String ref1, String codabar2, String ref2) {
        ...
        if (ref1.length() >= 15 || ref2.length() >= 15) {
            ...
            try {
                ...
                ps.println("^FO716,96^GFA,01152,01152,00012,:Z64:");
                ps.println(":C4B5");
                ps.println("^FO428,96^GFA,01152,01152,00012,:Z64:");
                ps.println(":C4B5");
                ps.println("^BY2,2,71^FT766,38^BEI,,Y,N");
                ps.println("^FD" + codabar1 + "^FS");
                ps.println("^FT733,144^A0I,20,21^FH\\^FD" + partes1[0] + "^FS");
                ps.println("^FT733,120^A0I,20,21^FH\\^FD/" + partes1[1] + "^FS");
                ps.println("^BY2,2,71^FT478,38^BEI,,Y,N");
                ps.println("^FD" + codabar2 + "^FS");
                ps.println("^FT445,144^A0I,20,21^FH\\^FD" + partes2[0] + "^FS");
                ps.println("^FT445,120^A0I,20,21^FH\\^FD/" + partes2[1] + "^FS");
                ps.println("^PQ1,0,1,Y^XZ");
            ...
            try {
                ...
                ps.println("^BY2,2,71^FT478,38^BEI,,Y,N");
                ps.println("^FD" + codabar2 + "^FS");
                ps.println("^FT445,144^A0I,20,21^FH\\^FD" + ref2 + "^FS");
                ps.println("^PQ1,0,1,Y^XZ");
    ...
    public void print3x(String codabar1, String ref1, String codabar2, String ref2, String codabar3, String ref3) {
        if (ref1.length() >= 15 || ref2.length() >= 15 || ref3.length() >= 15) {
            ...
            try {
                ...
                ps.println("^FO428,96^GFA,01152,01152,00012,:Z64:");
                ps.println(":C4B5");
                ps.println("^FO140,96^GFA,01152,01152,00012,:Z64:");
                ...
                ps.println("^FT733,144^A0I,20,21^FH\\^FD" + partes1[0] + "^FS");
                ps.println("^FT733,120^A0I,20,21^FH\\^FD/" + partes1[1] + "^FS");
                ps.println("^BY2,2,71^FT468,38^BEI,,Y,N");
                ps.println("^FD" + codabar2 + "^FS");
                ps.println("^FT445,144^A0I,20,21^FH\\^FD" + partes2[0] + "^FS");
                ps.println("^FT445,120^A0I,20,21^FH\\^FD/" + partes2[1] + "^FS");
                ps.println("^BY2,2,71^FT181,38^BEI,,Y,N");
                ps.println("^FD" + codabar3 + "^FS");
                ps.println("^FT158,144^A0I,20,21^FH\\^FD" + partes3[0] + "^FS");
                ps.println("^FT158,120^A0I,20,21^FH\\^FD/" + partes3[1] + "^FS");
                ps.println("^PQ1,0,1,Y^XZ");
                ps.close();
                Notification noti = new Notification(this, Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Etiqueta impressa com sucesso!");
                noti.showNotification();
            ...
            try {
                ...
                ps.println("^BY2,2,71^FT756,38^BEI,,Y,N");
                ps.println("^FD" + codabar1 + "^FS");
                ps.println("^FT743,144^A0I,20,21^FH\\^FD" + ref1 + "^FS");
                ps.println("^BY2,2,71^FT478,38^BEI,,Y,N");
                ps.println("^FD" + codabar2 + "^FS");
                ps.println("^FT455,144^A0I,20,21^FH\\^FD" + ref2 + "^FS");
                ps.println("^BY2,2,71^FT181,38^BEI,,Y,N");
                ps.println("^FD" + codabar3 + "^FS");
                ps.println("^FT168,144^A0I,20,21^FH\\^FD" + ref3 + "^FS");
                ps.println("^PQ1,0,1,Y^XZ");
                ps.close();
                Notification noti = new Notification(this, Notification.Type.SUCCESS, Notification.Location.TOP_CENTER, "Etiqueta impressa com sucesso!");
                noti.showNotification();
    ...
    private void btPrinterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPrinterActionPerformed
        ...
        if (etiqueta1.isSelected()) {
            ...
            switch (tablePrintBox.getRowCount()) {
                case 1: {
                    String getCodigo1 = (tablePrintBox.getModel().getValueAt(0, 0).toString());
                    String getBox1 = (tablePrintBox.getModel().getValueAt(0, 1).toString());

                    print1x(getCodigo1, getBox1);
                    break;
                }
                case 2: {
                    String getCodigo1 = (tablePrintBox.getModel().getValueAt(1, 0).toString());
                    String getCodigo2 = (tablePrintBox.getModel().getValueAt(1, 0).toString());
                    String getBox1 = (tablePrintBox.getModel().getValueAt(1, 1).toString());
                    String getBox2 = (tablePrintBox.getModel().getValueAt(1, 1).toString());

                    print2x(getCodigo1, getBox1, getCodigo2, getBox2);
                    break;
                }
                case 3: {
                    String getCodigo1 = (tablePrintBox.getModel().getValueAt(0, 0).toString());
                    ...
                    String getCodigo2 = (tablePrintBox.getModel().getValueAt(1, 0).toString());
                    String getBox2 = (tablePrintBox.getModel().getValueAt(1, 1).toString());
                    String getCodigo3 = (tablePrintBox.getModel().getValueAt(2, 0).toString());
                    String getBox3 = (tablePrintBox.getModel().getValueAt(2, 1).toString());

                    print3x(getCodigo1, getBox1, getCodigo2, getBox2, getCodigo3, getBox3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(printBox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
