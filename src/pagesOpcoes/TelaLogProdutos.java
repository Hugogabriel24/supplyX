 ...
 * @author hugogabriel
 */
public class TelaLogProdutos extends javax.swing.JFrame {

    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;

    public TelaLogProdutos() {
        initComponents();
    ...
    public void ListarDadosAdd() {
        String sql = "select idlogpartepecas as ID,message as MESSAGE,datalog as CREATIONDATA from logpartepecas where tipolog = ?";
        try {
    ...
    private void initComponents() {
        ...
        tabb.addTab("Produtos adicionados", jPanel3);
        ...
        tabb.addTab("Produtos editados", jPanel4);
        ...
        tabb.addTab("Produtos excluidos", jPanel5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLogProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLogProdutos().setVisible(true);
            }
        });
    }
