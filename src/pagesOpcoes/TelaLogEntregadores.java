 ...
 * @author hugogabriel
 */
public class TelaLogEntregadores extends javax.swing.JFrame {

    Connection conexao = null;
    PreparedStatement pst = null;
    ResultSet rs = null;

    public TelaLogEntregadores() {
        initComponents();
    ...
    public void ListarDadosAdd() {
        String sql = "select idlogentre as ID,message as MESSAGE,datalog as CREATIONDATA from logentre where tipolog = ?";
        try {
    ...
    private void initComponents() {
        ...
        tabb.addTab("Entregadores adicionados", jPanel3);
        ...
        tabb.addTab("Entregadores editados", jPanel4);
        ...
        tabb.addTab("Entregadores excluidos", jPanel5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLogEntregadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLogEntregadores().setVisible(true);
            }
        });
    }
