...
public class TelaLogFunc extends javax.swing.JFrame {
    ...
    public void ListarDadosAdd() {
        String sql = "select idlogfunc as ID,message as MESSAGE,datalog as CREATIONDATA from logfunc where tipolog = ?";
        try {
    ...
    private void initComponents() {
        ...
        tabb.addTab("Funcionarios adicionados", jPanel3);
        ...
        tabb.addTab("Funcionarios editados", jPanel4);
        ...
        tabb.addTab("Funcionarios excluidos", jPanel5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLogFunc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLogFunc().setVisible(true);
            }
        });
    }
