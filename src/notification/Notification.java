...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            icone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/sucess.png")));
            lbMessage.setText("Successo");
        } else if (type == Type.INFO) {
            icone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/info.png")));
            lbMessage.setText("Info");
        } else if(type == Type.SERVICE) {
            icone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/warning.png")));
            lbMessage.setText("Message Service!");
        } else {
            icone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/warning.png")));
            lbMessage.setText("Atenção");
        }
    ...
    private void initComponents() {
        ...
        icone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/sucess.png"))); // NOI18N

        painelView.setOpaque(false);

        lbMessage.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        lbMessage.setForeground(new java.awt.Color(0, 0, 0));
        lbMessage.setText("MESSAGE");

        lbMessageText.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        lbMessageText.setForeground(new java.awt.Color(153, 153, 153));
        lbMessageText.setText("Message_text");
        ...
        painelViewLayout.setHorizontalGroup(
            ...
            .addGroup(painelViewLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(painelViewLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(icone)
                .addGap(10, 10, 10)
                .addComponent(painelView, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(icone, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
